...
var App = function () {
    ...
    var uiInit = function() {
        ...
        $('.input-typeahead-country').typeahead({ source: exampleTypeheadData });
        
        // Initialize Typehead for Users search
        var usersTypeHead = ["Eric Stone", "Roy Wong", "Wille Walsh", "Alan George", "Zachary Rios", "Janet Bell", "Ben Peterson", "Frank woods", "Tomothy Franklin", "Bryan Butler", "Isaac Johnson", "Cory Webb", "Gabriel Howell", "Toni George", "Gregory Byrd", "Leonard Rogers", "Stacy Daniels", "Derrick Caldwell", "Lauren Watts"];
        $('.input-typeahead-users').typeahead({ source : usersTypeHead });
        
         var providersTypeHead = ["Enercoop", "L'Encadreur", "Star Canin", "Famille Heureuse", "Curmi Lefevre Anne", "La coupe à Toutou", "Look Canin", "Netoitou"];
        $('.input-typeahead-providers').typeahead({ source : providersTypeHead });
    ...
    var dtIntegration = function() {
        $.extend(true, $.fn.dataTable.defaults, {
            ...
            "oLanguage": {
                ...
                "sInfo": "<strong>_START_</strong> à <strong>_END_</strong> sur <strong>_TOTAL_</strong> entrées",
                "oPaginate": {
                    "sPrevious": "",
                    "sNext": ""
                }
